...
Example_Car_Images = r'C:\Users\Nick\Downloads\Example_Car_Images'
...
training_xml_path = os.path.join(Example_Car_Images, "training.xml")
testing_xml_path = os.path.join(Example_Car_Images, "testing.xml")
...
# results.
print("Showing detections on the images in the Example_Car_Images folder...")
win = dlib.image_window()
for f in glob.glob(os.path.join(Example_Car_Images, "*.jpg")):
...
images = [dlib.load_rgb_image(Example_Car_Images + '/Lot (1).jpg'),
          dlib.load_rgb_image(Example_Car_Images + '/Lot (2).jpg')]
